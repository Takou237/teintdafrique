-- Teint d'Afrique Cosmétiques — schéma pour LWS (compte LWS-826496, base teint2867914).
-- Sur LWS la base existe déjà (mot de passe fourni par LWS) et l'utilisateur n'a PAS le droit
-- de créer une autre base : ce script ne contient ni CREATE DATABASE ni USE.
-- À importer via phpMyAdmin (https://mysql2206.lwspanel.com/phpmyadmin) DANS la base teint2867914.
...
-- Messages reçus via le formulaire de contact du site public (lus par l'admin).
